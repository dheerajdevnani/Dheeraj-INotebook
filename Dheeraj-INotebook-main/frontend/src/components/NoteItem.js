...
function NoteItem({ note }) {
    ...
    const handleSubmit = (evt) => {
        ...
        handleClose(); // Close dialog after submitting edit
    };
                ...
                <form onSubmit={handleSubmit}>
                    <DialogContent style={{ paddingTop: "0.5rem" }}>
                        <DialogContentText style={{ fontFamily: "'Poppins', sans-serif", fontSize: "1rem", marginBottom: "0.5rem" }}>
                            Edit your note. Edit the fields that you want to change.
                        </DialogContentText>
                    ...
                    <DialogActions>
                        ...
                        <Button disabled={title.length < 3 || description.length < 3 || tag.length < 3} variant="contained" color="secondary" type="submit" style={{ textTransform: "none", fontFamily: "'Poppins', sans-serif", fontSize: "1rem" }}>Edit {note.title}</Button>
                    </DialogActions>
                </form>
            </Dialog>
            ...
            <div className="card">
                <div className="card-body">
                    <div className="d-flex align-items-center">
                        ...
                        <IconButton onClick={handleRemove} className="mb-2 ms-auto" color="secondary">
